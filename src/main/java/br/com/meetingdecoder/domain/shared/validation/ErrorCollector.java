...
public final class ErrorCollector {
    ...
    public ErrorCollector add(DomainError error) {
        Objects.requireNonNull(error);
        errors.add(error);
        return this;
    }

    public ErrorCollector check(
            boolean condition,
            DomainError error
    ) {
        if (!condition)
    ...
    public ErrorCollector requireNotNull(
            Object value,
            String field,
    ...
    public ErrorCollector requireNotBlank(
            String value,
            String field,
            DomainErrorCode code
    ) {
     ...
     */
    public ErrorCollector requireInRange(
            Double value,
            double min,
            double max,
            String field,
     ...
     * @return this for chaining
     */
    public ErrorCollector requireMinLessOrEqualMax(
            BigDecimal min,
            BigDecimal max,
            String fieldMin,
            String fieldMax,
     ...
     * @return this for chaining
     */
    public ErrorCollector requireDoubleNotNull(
            Double value,
            String field,
            DomainErrorCode code
    ) {
    ...
    public ErrorCollector merge(ErrorCollector other) {
